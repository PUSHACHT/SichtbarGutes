...
export default function App() {
  ...
  return (
    <div className="bg-white flex flex-col items-start w-full font-sans text-[#2b2a27]">
      ...
      {/* 2. HERO SECTION MIT VIDEO BACKGROUND & OVERLAY */}
      ...
      <section id="kompass" className="bg-white w-full px-6 sm:px-12 lg:px-[64px] py-[72px]">
        <div className="max-w-[1360px] mx-auto flex flex-col gap-[40px] items-start">
          ...
          <div className="flex flex-col lg:flex-row gap-[32px] items-start w-full">
            <div className="flex flex-col gap-[16px] items-start w-full lg:w-[813px]">
            ...
            <div className="bg-white border border-[#dcd8cf] p-[32px] flex flex-col gap-[24px] items-start w-full lg:w-[475px]">
        ...
        <div className="max-w-[1360px] mx-auto flex flex-col gap-[40px] items-start">
          ...
          <div className="flex flex-col gap-[24px] items-start w-full">
            ...
            <div className="flex flex-col gap-[24px] items-start w-full">
              ...
              <div className="bg-[#162d50] border border-[#162d50] p-[40px] flex flex-col gap-[20px] items-start w-full text-white">
      ...
      <section className="bg-white w-full px-6 sm:px-12 lg:px-[64px] py-[72px]">
        <div className="max-w-[1360px] mx-auto flex flex-col gap-[40px] items-start">
          ...
          <div className="flex flex-col gap-[32px] items-start w-full">
            ...
            <div className="flex flex-col lg:flex-row gap-[32px] items-start w-full">
              <div className="bg-white border border-[#dcd8cf] p-[32px] flex flex-col gap-[16px] items-start w-full lg:w-[813px]">
                <p className="text-[#162d50] text-[20px] font-bold">
                  DSEE-Expertise
                </p>
              ...
              <div className="bg-white border border-[#dcd8cf] p-[24px] flex flex-col gap-[16px] items-start w-full lg:w-[475px]">
            ...
            <div className="flex flex-col lg:flex-row gap-[32px] items-start w-full">
              ...
              <div className="bg-[#162d50] border border-[#162d50] p-[32px] flex flex-col gap-[16px] items-start w-full lg:w-[813px] text-white">
          ...
          <div className="flex flex-col gap-[28px] items-start w-full pt-[32px] border-t border-[#dcd8cf]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px] items-stretch w-full">
              {testimonials.map((item, idx) => (
                <div 
                  key={idx}
                  className="bg-white border border-[#dcd8cf] p-[28px] flex flex-col justify-between gap-6 hover:border-[#162d50] transition-all relative shadow-sm"
                >
                  <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-[24px] items-start w-full">
            ...
            <div className="flex flex-col items-start w-full divide-y divide-[#dcd8cf]">
              {faqs.map((faq, idx) => {
                ...
                return (
                  <div key={idx} className="py-[24px] flex flex-col gap-[12px] items-start w-full">
                    <button
      ...
      {/* 10. SEKTION 06 / ANTRAGSSERVICE STARTEN (CONTACT & FORM) */}
      <section id="kontakt" className="bg-[#162d50] w-full px-6 sm:px-12 lg:px-[64px] py-[72px] text-white">
        <div className="max-w-[1360px] mx-auto flex flex-col lg:flex-row gap-[32px] items-start">
          ...
          <div className="flex flex-col gap-[24px] items-start w-full lg:w-[813px] shrink-0">
          ...
          <div className="bg-white border border-[#dcd8cf] p-[32px] flex flex-col gap-[20px] items-start w-full lg:w-[475px] shrink-0 text-[#2b2a27]">
            {submitted ? (
